  ...
  return (
    <div className="flex w-full top-0 left-0 items-center hover:text-black bg-transparent fixed md:hover:bg-white  z-40 ">
      <div className=" flex  justify-between items-center mx-auto hover:text-black md:px-10">
        ...
        <div className="md:flex hidden hover:text-black text-black text-base items-center justify-center lg:w-[1380px] xxl:w-[2600px] ">
        ...
        {/* right navbar start */}
        <div className="md:flex hidden text-black  hover:text-black ">
          <Link to="/create">
