...
function Model3() {
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-7 absolute bottom-0 left-0 right-0 sm:top-[500px] md:top-[500px] xl:top-[500px] xxl:top-[720px] justify-center items-center	">
